...
function HeroContent({ data }: HeaderHeroProps) {
  ...
  return (
    <section ref={ref} className="relative flex h-screen items-center justify-center bg-[#000c49] text-white overflow-hidden">
